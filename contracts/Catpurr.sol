...
/**
    * @title Catpurr
    * @dev Catpurr is a standard ERC20 token with additional functionalities:
    * - Tax handling
    * - Treasury handling
    * - Burning
 */
contract CATPURR is Context, IERC20, IERC20Metadata, Ownable, IERC20Burnable {
    ...
    event TaxHandlerChanged(address oldTaxHandlerAddress, address newTaxHandlerAddress);

    event TreasuryHandlerChanged(address oldTreasuryHandlerAddress, address newTreasuryHandlerAddress);
    ...
    */
    /**
     * @dev Sets the tax handler contract address.
     * Only the contract owner can call this function.
     * Emits a `TaxHandlerChanged` event.
     * @param taxHandlerAddress The address of the tax handler contract.
     */
    ...
    /**
     * @dev Sets the treasury handler contract address.
     * Only the contract owner can call this function.
     * Emits a `TreasuryHandlerChanged` event.
     * @param treasuryHandlerAddress The address of the treasury handler contract.
     */
     ...
     * Overrides the `burn` function from the parent contract.
     ...
     * Overrides the `burnFrom` function from the parent contract.
